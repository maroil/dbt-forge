			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'lint', slug: 'docs/cli/lint' },
						{ label: 'impact', slug: 'docs/cli/impact' },
						{ label: 'cost', slug: 'docs/cli/cost' },
						{ label: 'contracts', slug: 'docs/cli/contracts' },
						{ label: 'changelog', slug: 'docs/cli/changelog' },
